          ...
          <div className="flex min-h-[100px] items-center justify-center rounded-lg bg-muted p-4">
            {hello.isLoading ? (
              ...
              <div className="text-center">
                ...
                <p className="mt-2 text-xs text-muted-foreground">Last updated: {new Date().toLocaleTimeString()}</p>
              </div>
            )}
          </div>
        </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <ul className="space-y-1 text-sm">
              <li>
                Status: <span className="font-mono">{hello.status}</span>
              </li>
              <li>
                Fetching: <span className="font-mono">{hello.isFetching ? 'Yes' : 'No'}</span>
              </li>
              <li>
                Stale: <span className="font-mono">{hello.isStale ? 'Yes' : 'No'}</span>
              </li>
            </ul>
          </CardContent>
        </Card>
